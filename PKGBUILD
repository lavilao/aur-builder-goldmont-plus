...
pkgver=0.3.6+6.r3339.20240814.0a8d6ea8
pkgrel=1
arch=(
  'armv7h'
  'aarch64'
...
_cmake_options_common="
  ...
  -DLLAMA_SERVER_SSL=ON -DLLAMA_SERVER_VERBOSE=ON -DCMAKE_C_FLAGS=-march=goldmont-plus -DCMAKE_CXX_FLAGS=-march=goldmont-plus -DGGML_AVX=off
"
